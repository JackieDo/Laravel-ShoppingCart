...
class Cart {
	...
	public function associate($modelName, $modelNamespace = null)
	{
		...
		if( ! class_exists($model)) {
			throw new Exceptions\ShoppingcartUnknownModelException('Invalid associate model name. Not found class "' .$model. '".');
		}
	...
	public function update($rawId, $attribute)
	{
		if(!$row = $this->get($rawId)) {
			throw new Exceptions\ShoppingcartInvalidRawIDException('Item not found.');
		}
